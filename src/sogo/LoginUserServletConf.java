...
public class LoginUserServletConf extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("login_name", dao.getUser(id, pass));
		session.setAttribute("login_dep", dao.getDept(id, pass));
		session.setAttribute("login_status", dao.getStatus(id, pass));
		String requestedId = (String) session.getAttribute("login_name");
		if (requestedId != null) {
			/**
			 * 遷移先をmenu.jspに定める
			 */
